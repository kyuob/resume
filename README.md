...
## 기술 요약
 - iOS 클라이언트 앱 개발 및 애플 앱스토어 출시 및 관리
 - objective-c, swift 사용 가능, objective-c -> swift 마이그레이션 가능
 - 대규모 서버 통신 프로젝트 경험, 금융권 대형 프로젝트 파트 리더 경험
  
## 기능 구현:
 - 하이브리드 앱 구축, 네이티브 웹간 브릿지 기능 구현
 - 네이티브 UI 기본 구현 및 커스텀 가능, UI 애니메이션 구현
 - openGL, FFMPEG 라이브러리 사용 하여 게임및 카메라 앱 구현
 - 보안 패킷 적용 실시간 NVR 카메라 앱 구현
 - 다국어 지원 글로벌 앱 기능 구현 
...
<img src="images/17.png" height="380"/>   <img src="images/21.jpg" height="380"/>


Dal.komm 카페 iOS 앱 개발 100% 관여

<img src="images/18.png" height="380"/>   <img src="images/19.png" height="380"/>
...
<img src="images/08.png" width="960"/>
